...
10. FLAG RULES (read carefully):
    PAY_BACK=true: 
      - INCOME = you borrowed money from someone (มีหนี้)
      - EXPENSE = you are paying back money you borrowed
    REIMBURSE=true:
      - EXPENSE = you paid for someone else and expect them to pay you back (จ่ายแทน)
      - INCOME = someone is paying you back what they owed you
    REPAY=true:
      - EXPENSE = you paid work/study expense with own money, claimable from org (เบิกได้)
      - INCOME = org is reimbursing you for that expense
    ...
    NOTE: Only ONE flag can be true per transaction. If unclear, all false.
        ...
        {txs.map((tx,i) => (
          <div key={i} style={{marginBottom:16,padding:14,background:C.muted,borderRadius:10,border:`1px solid ${C.border}`}}>
            ...
            <div style={{display:'flex',gap:16,marginTop:10,flexWrap:'wrap'}}>
              {[['REIMBURSE','🔄 คืนเงิน (friend)'],['REPAY','🏢 เบิกได้ (org)'],['PAY_BACK','💸 หนี้ (debt)']].map(([f,l])=>(
